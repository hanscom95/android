...
public class Mail extends javax.mail.Authenticator {
    ...
    public Mail() {
        ...
        _user = "fivics.shootingzone@gmail.com"; // username
        _pass = "shootingzone+artech"; // password
        _path = "";
        _from = "fivics.shootingzone@gmail.com"; // email sent from
    ...
    public Mail(String user, String pass, String path) {
        this();
    ...
    public boolean send() throws Exception {
        ...
        if (!_user.equals("") && !_pass.equals("") && _to.length > 0
            ...
            String fileName = Environment.getExternalStorageDirectory()+"/shootingzone/"+_path;
//            Log.d("Mail", "fath  ================== : " + fileName);
            DataSource source = new FileDataSource(fileName);
            messageBodyPart2.setDataHandler(new DataHandler(source));
            messageBodyPart2.setFileName("ShootingZone");
