...
import artech.com.semi.NaverMapActivity;
 ...
 * @author kyjkim
 */
public class NMapViewer extends NMapActivity implements AppCompatCallback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (USE_XML_LAYOUT) {
            //create the delegate
            NMapActivity activity = NMapActivity.getInstance();
            AppCompatDelegate delegate = AppCompatDelegate.create(activity, this);

            //call the onCreate() of the AppCompatDelegate
            delegate.onCreate(savedInstanceState);

            delegate.setContentView(R.layout.activity_naver_map);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.naver_menu, menu);
        return true;
    }
