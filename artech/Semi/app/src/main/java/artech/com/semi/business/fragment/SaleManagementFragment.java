...
public class SaleManagementFragment extends Fragment{
    ...
    SaleManagementAdapter mAdapter;
    SaleManagementFragment mFragment;
    ...
    @SuppressLint("ValidFragment")
    public SaleManagementFragment(Context context) {
     ...
     * number.
     */
    public static SaleManagementFragment newInstance(Context context, int sectionNumber) {
        SaleManagementFragment fragment = new SaleManagementFragment(context);
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if(success) {
                ...
                if(mJsonArray.length() > 0) {
                    ...
                    mAdapter = new SaleManagementAdapter(mFragment, mContext);
                    mAdapter.clear();
