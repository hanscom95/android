...
public class SaleManagementAdapter extends RecyclerView.Adapter<SaleManagementAdapter.ViewHolder> {
    ...
    SaleManagementFragment mSaleManagementFragment;
    Context mContext;

    public SaleManagementAdapter(SaleManagementFragment saleManagementFragment, Context context) {
        super();
        mSaleManagementFragment = saleManagementFragment;
        mContext = context;
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int i) {
        ...
        viewHolder.statusText.setText("판매준비");
        ...
        viewHolder.detailLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mSaleManagementFragment.setDetailClick(i);
            }
        });
    }
