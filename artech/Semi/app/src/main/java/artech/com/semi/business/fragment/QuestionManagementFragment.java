...
import artech.com.semi.business.QuestionManagementDetailActivity;
import artech.com.semi.business.adpater.QuestionManagementAdapter;
...
public class QuestionManagementFragment extends Fragment{
    ...
    QuestionManagementAdapter mAdapter, mSecondAdapter;
    QuestionManagementFragment mFragment;
     ...
     * number.
     */
    public static QuestionManagementFragment newInstance(Context context, int sectionNumber) {
        QuestionManagementFragment fragment = new QuestionManagementFragment(context);
    ...
    public void setDetailClick(int i) {
        ...
        try {
            Intent intent = new Intent(mContext, QuestionManagementDetailActivity.class);
            intent.putExtra("id", mJsonArray.getJSONObject(i).getString("question_id"));
    ...
    private class SelectTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                connect = network.reviewProductSelect(jsonObject);
            }catch (Exception e) {
                e.printStackTrace();
                return false;
            }
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if(success) {
                ...
                mInfoText.setText(firstJsonArray.length() + "개의 문의글이 있습니다.");

                mAdapter = new QuestionManagementAdapter(mFragment, mContext, 0);
                mSecondAdapter = new QuestionManagementAdapter(mFragment, mContext, 1);
                mAdapter.clear();
