...
public class PurchaseHistorySuccessActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_normal_purchase_history_success);
        ...
        try {
            ...
            jsonObject.put("state", 1); // 판매완료
            jsonObject.put("flag", 0); // 구매자
    ...
    private class SelectTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if(success) {
                ...
                mAdapter = new PurchaseHistoryAdapter(mContext, 1);
                mAdapter.clear();
