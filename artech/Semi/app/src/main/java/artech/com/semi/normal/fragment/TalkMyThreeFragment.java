...
import artech.com.semi.normal.adapter.TalkMyThreeAdapter;
...
public class TalkMyThreeFragment extends Fragment{
...
//    RadioGroup mRadioGroup;
    ...
    @SuppressLint("ValidFragment")
    public TalkMyThreeFragment(Context context) {
     ...
     * number.
     */
    public static TalkMyThreeFragment newInstance(Context context, int sectionNumber) {
        TalkMyThreeFragment fragment = new TalkMyThreeFragment(context);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_talk_my_tab_three, container, false);
    ...
    private class SelectTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                connect = network.talkMyPictureSelect(mJsonObject);
            }catch (Exception e) {
                e.printStackTrace();
                return false;
            }
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            mAdapter = new TalkMyThreeAdapter(mFragment, mContext);
            mAdapter.clear();
