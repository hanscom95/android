...
import artech.com.semi.normal.adapter.TalkMyFourAdapter;
...
public class TalkMyFourFragment extends Fragment{
...
//    RadioGroup mRadioGroup;
    ...
    @SuppressLint("ValidFragment")
    public TalkMyFourFragment(Context context) {
     ...
     * number.
     */
    public static TalkMyFourFragment newInstance(Context context, int sectionNumber) {
        TalkMyFourFragment fragment = new TalkMyFourFragment(context);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_talk_my_tab_four, container, false);
    ...
    private class SelectTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                connect = network.talkMyScrapSelect(mJsonObject);
            }catch (Exception e) {
                e.printStackTrace();
                return false;
            }
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            mAdapter = new TalkMyFourAdapter(mFragment, mContext);
            mAdapter.clear();
