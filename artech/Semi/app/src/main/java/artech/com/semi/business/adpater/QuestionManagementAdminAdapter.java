 ...
 */
public class QuestionManagementAdminAdapter extends RecyclerView.Adapter<QuestionManagementAdminAdapter.ViewHolder> {
    ...
    public QuestionManagementAdminAdapter(QuestionManagementAdminFragment fragment, Context context, int flag) {
        super();
        mFragment = fragment;
        mContext = context;
    ...
    public void addList(JSONArray mJsonArray) {
        ...
        for(int i = 0; i < mJsonArray.length() ;i++) {
            ...
            try {
                nama.setId(mJsonArray.getJSONObject(i).getString("question_id")+"");
                ...
                nama.setTitle(Html.fromHtml(mJsonArray.getJSONObject(i).getString("review")).toString());
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            regText = (TextView) itemView.findViewById(R.id.purchase_time);
            titleText = (TextView) itemView.findViewById(R.id.purchase_title);
            nameText = (TextView) itemView.findViewById(R.id.purchase_name);
            waitingText = (TextView) itemView.findViewById(R.id.waiting_text);
