...
public class TalkMyOneFragment extends Fragment{
    ...
    @SuppressLint("ValidFragment")
    public TalkMyOneFragment(Context context) {
     ...
     * number.
     */
    public static TalkMyOneFragment newInstance(Context context, int sectionNumber) {
        TalkMyOneFragment fragment = new TalkMyOneFragment(context);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_talk_my_tab_one, container, false);
    ...
    private class SelectTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                connect = network.talkMySelect(mJsonObject);
            }catch (Exception e) {
                e.printStackTrace();
                return false;
            }
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            mAdapter = new TalkMyOneAdapter(mFragment, mContext);
            mAdapter.clear();
