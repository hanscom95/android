...
import artech.com.semi.business.adpater.QuestionManagementAdminAdapter;
...
public class QuestionManagementAdminFragment extends Fragment{
    ...
    QuestionManagementAdminAdapter mAdapter, mSecondAdapter;
    QuestionManagementAdminFragment mFragment;
    ...
    @SuppressLint("ValidFragment")
    public QuestionManagementAdminFragment(Context context) {
     ...
     * number.
     */
    public static QuestionManagementAdminFragment newInstance(Context context, int sectionNumber) {
        QuestionManagementAdminFragment fragment = new QuestionManagementAdminFragment(context);
    ...
    private class SelectTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if(success) {
                ...
                mAdapter = new QuestionManagementAdminAdapter(mFragment, mContext, 0);
                mSecondAdapter = new QuestionManagementAdminAdapter(mFragment, mContext, 1);
                mAdapter.clear();
