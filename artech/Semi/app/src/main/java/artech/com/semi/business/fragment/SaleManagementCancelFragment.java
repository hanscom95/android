...
import artech.com.semi.business.adpater.SaleManagementCancelAdapter;
...
public class SaleManagementCancelFragment extends Fragment{
    ...
    SaleManagementCancelAdapter mAdapter;
    SaleManagementCancelFragment mFragment;
    RelativeLayout mNotSearchLayout, mFirstLayout;
    TextView mInfoText;
    ...
    @SuppressLint("ValidFragment")
    public SaleManagementCancelFragment(Context context) {
     ...
     * number.
     */
    public static SaleManagementCancelFragment newInstance(Context context, int sectionNumber) {
        SaleManagementCancelFragment fragment = new SaleManagementCancelFragment(context);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_sale_management_cancel, container, false);

        mNotSearchLayout = mView.findViewById(R.id.not_search_layout);
        mFirstLayout = mView.findViewById(R.id.first_layout);
        mInfoText = mView.findViewById(R.id.info_text);
        ...
        mAdapter = new SaleManagementCancelAdapter(this, mContext);
    ...
    public void setDetailClick(final int i) {
        ...
        cancelButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    Log.d("time", "receiptDate: " + receiptDate.getTime() + " / nowDate: " + nowDate.getTime() +  " / time : " + time + " / minus : " + minus);
...
//                Log.d("BusinessMainActivity", "mAdminTask : " + mJsonArray.toString());
                ...
                if(mJsonArray.length() > 0) {
                    mAdapter = new SaleManagementCancelAdapter(mFragment, mContext);
                    mAdapter.clear();
                    mAdapter.addList(mJsonArray);
                    mRecyclerView.setAdapter(mAdapter);

                    mInfoText.setText("판매취소 내역 총 " + mJsonArray.length() + "건");
...
//                connect = network.iamportCancelSelect(jsonObject);
                ...
                object.put("imp_uid", mJsonArray.getJSONObject(0).getString("imp_uid"));
                object.put("merchant_uid", mJsonArray.getJSONObject(0).getString("merchant_uid"));
                object.put("amount", mJsonArray.getJSONObject(0).getString("price"));
