 ...
 */
public class FavoritesShopAdapter extends RecyclerView.Adapter<FavoritesShopAdapter.ViewHolder> {
    ...
    public FavoritesShopAdapter(Context context) {
        super();
        mContext = context;
    ...
    public void addList(JSONArray mJsonArray) {
        ...
        for(int i = 0; i < mJsonArray.length() ;i++) {
            ...
            try {
                nama.setId(mJsonArray.getJSONObject(i).getString("market_id"));
                nama.setFId(mJsonArray.getJSONObject(i).getString("favorites_id"));
                nama.setTitle(Html.fromHtml(mJsonArray.getJSONObject(i).getString("company")).toString());
                nama.setContents(Html.fromHtml(mJsonArray.getJSONObject(i).getString("address")).toString());
    ...
    public ViewHolder onCreateViewHolder(final ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.adapter_normal_shop_favorites_list_view, viewGroup, false);
