...
public class TalkFourFragment extends Fragment{
    ...
    @SuppressLint("ValidFragment")
    public TalkFourFragment(Context context) {
     ...
     * number.
     */
    public static TalkFourFragment newInstance(Context context, int sectionNumber) {
        TalkFourFragment fragment = new TalkFourFragment(context);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_talk_tab_four, container, false);
