...
bool compareContourYPosLow(std::vector<cv::Point> contour1, std::vector<cv::Point> contour2);
void delHighContours(vector<vector<Point> >& inputCont, int yCoor);
...
/* Header for class artech_com_arcam_autoScoringNativeClass_autoScoring */

#ifndef _Included_artech_com_arcam_autoScoringNativeClass_autoScoring
#define _Included_artech_com_arcam_autoScoringNativeClass_autoScoring
#ifdef __cplusplus
extern "C" {
#endif
	/*
	* Class:     artech_com_arcam_autoScoringNativeClass
	* Method:    autoScoringSegmentation, autoScoringEvaluation, detectMotion
	* Signature: (JJ)I
	*/

	JNIEXPORT jfloatArray JNICALL Java_artech_com_arcam_autoScoringNativeClass_autoScoringSegmentation
	(JNIEnv *, jclass, jlong, jintArray, jfloatArray);

	JNIEXPORT jint JNICALL Java_artech_com_arcam_autoScoringNativeClass_autoScoringEvaluation
	(JNIEnv *, jclass, jlong, jlong, jlong);

	JNIEXPORT jint JNICALL Java_artech_com_arcam_autoScoringNativeClass_detectMotion
