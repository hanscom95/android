...
//		setBackgroundColor(Color.TRANSPARENT); // ���� ����(�����)
	...
	public boolean Initialize(int width, int height, int labelPointer) {
		...
		if(width < leftPadding + rightPadding || height < topPadding + bottomPadding){
			...
			height = topPadding + bottomPadding + 100+100;
...
//				}
				...
				//� �׸���
				if(MainActivity.sgaCheckBox.isChecked()){
					canvas.drawPath(path1, paint1);
				}
				if(MainActivity.bma250CheckBox.isChecked()){
					canvas.drawPath(path2, paint2);
				}
				if(MainActivity.lis331dlhCheckBox.isChecked()){
					canvas.drawPath(path3, paint3);
				}
//				if(MainActivity.mpu6500CheckBox.isChecked()){
...
//				}
	...
	class Data {
		// -32768 +32767
		final static public int MIN = -1000;	//�ּ� �Է°�
		final static public int MAX = 1000;	//�ִ� �Է°�
		int x; // �Է��� ����
		int value; // ���� ��ǥ ��
