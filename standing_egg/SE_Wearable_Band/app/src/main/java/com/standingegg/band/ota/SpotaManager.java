...
//                setSpotaGpioMap();
            ...
            case 5:
                ...
                ULog.d(TAG, "mem info: " + stringValue);
	...
	private void readMemInfo() {
        ...
        if (BluetoothGattSingleton.getSpotaMemInfoCharacteristic() != null) {
            ...
            ULog.e(TAG, "spotaMemInfoCharacteristic not set");
        }
    }
    ...
    private void processMemDevValue(int memDevValue) {
        ...
        ULog.d(TAG, "processMemDevValue() step: " + step + ", value: " + stringValue);
        switch (step) {
			case 2:
				if(memDevValue == 0x1) {
