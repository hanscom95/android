...
public class GlRenderer implements Renderer {
  ...
  private static final float OBJECT_DISTANCE = -7.0f;
...
//    gl.glRotatef(this.mRotationAngle++, 0, 1, 0);
     ...
     * TEST
     */
    gl.glRotatef(TwoFragment.testX , 1, 0, 0);
    gl.glRotatef(TwoFragment.testY , 0, 1, 0);
 //   gl.glRotatef(TwoFragment.testZ , 0, 0, 1);
  ...
  @Override
  public void onSurfaceChanged(final GL10 gl, int width, final int height) {
  ...
  public void onSurfaceCreated(final GL10 gl, final EGLConfig config) {
    this.mEarth.loadGLTexture(gl, this.mContext, R.drawable.sphere04);
