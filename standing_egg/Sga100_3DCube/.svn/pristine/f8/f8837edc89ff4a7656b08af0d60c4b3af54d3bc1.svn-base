...
public class Sphere {
   ...
   *
   * @param gl Handle.
   * @param mContext Handle.
   * @param texture Texture map for the sphere.
   */
  public void loadGLTexture(final GL10 gl, final Context mContext, final int texture) {
    final Bitmap bitmap = BitmapFactory.decodeResource(mContext.getResources(), texture);
