...
//        stopSensor();
    ...
    private void dbSearch() {
        ...
        Cursor cursor = dbManager.selectRun(today);
        while (cursor.moveToNext()) {
            Log.d("Running", "Run getPosition : " +cursor.getPosition() +"//today : " + cursor.getString(0) + "//count : " + cursor.getInt(1) + "//goal : " + cursor.getInt(2) + "//date : " + cursor.getString(3) + "//hour : " + cursor.getString(4));
