package se.com.band.utility;// Generated by the protocol buffer compiler.  DO NOT EDIT!
...
public final class StnEggPkt {
  ...
  public interface StnEggPacketOrBuilder extends
    ...
    /**
     * <code>optional int32 filteredMotion = 76;</code>
     */
    boolean hasFilteredMotion();
    /**
     * <code>optional int32 filteredMotion = 76;</code>
     */
    int getFilteredMotion();

    /**
     * <code>optional int32 fallStatus = 77;</code>
     */
    boolean hasFallStatus();
    /**
     * <code>optional int32 fallStatus = 77;</code>
     */
    int getFallStatus();
    ...
    /**
     * <code>optional int32 freeFall = 78;</code>
     */
    boolean hasFreeFall();
    /**
     * <code>optional int32 freeFall = 78;</code>
    ...
    /**
     * <code>optional int32 impact = 79;</code>
     */
    boolean hasImpact();
    /**
     * <code>optional int32 impact = 79;</code>
    ...
    /**
     * <code>optional int32 lying = 80;</code>
     */
    boolean hasLying();
    /**
     * <code>optional int32 lying = 80;</code>
    ...
    /**
     * <code>optional int32 min = 81;</code>
     */
    boolean hasMin();
    /**
     * <code>optional int32 min = 81;</code>
    ...
    /**
     * <code>optional int32 max = 82;</code>
     */
    boolean hasMax();
    /**
     * <code>optional int32 max = 82;</code>
  ...
  public static final class StnEggPacket extends
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 608: {
              ...
              filteredMotion_ = input.readInt32();
              break;
            }
            case 616: {
              bitField2_ |= 0x00001000;
              fallStatus_ = input.readInt32();
              break;
            }
            case 624: {
              bitField2_ |= 0x00002000;
              freeFall_ = input.readInt32();
              break;
            }
            case 632: {
              bitField2_ |= 0x00004000;
              impact_ = input.readInt32();
              break;
            }
            case 640: {
              bitField2_ |= 0x00008000;
              lying_ = input.readInt32();
              break;
            }
            case 648: {
    ...
    public static final int FILTEREDMOTION_FIELD_NUMBER = 76;
    private int filteredMotion_;
    /**
     * <code>optional int32 filteredMotion = 76;</code>
     */
    public boolean hasFilteredMotion() {
      return ((bitField2_ & 0x00000800) == 0x00000800);
    }
    /**
     * <code>optional int32 filteredMotion = 76;</code>
     */
    public int getFilteredMotion() {
      return filteredMotion_;
    }

    public static final int FALLSTATUS_FIELD_NUMBER = 77;
    private int fallStatus_;
    /**
     * <code>optional int32 fallStatus = 77;</code>
     */
    public boolean hasFallStatus() {
    ...
    public static final int FREEFALL_FIELD_NUMBER = 78;
    private int freeFall_;
    /**
     * <code>optional int32 freeFall = 78;</code>
     */
    public boolean hasFreeFall() {
    ...
    public static final int IMPACT_FIELD_NUMBER = 79;
    private int impact_;
    /**
     * <code>optional int32 impact = 79;</code>
     */
    ...
    public static final int LYING_FIELD_NUMBER = 80;
    private int lying_;
    /**
     * <code>optional int32 lying = 80;</code>
     */
    public boolean hasLying() {
    ...
    public static final int MIN_FIELD_NUMBER = 81;
    private int min_;
    /**
     * <code>optional int32 min = 81;</code>
     */
    ...
    public static final int MAX_FIELD_NUMBER = 82;
    private int max_;
    /**
     * <code>optional int32 max = 82;</code>
     */
    ...
    public int getSerializedSize() {
      ...
      if (((bitField2_ & 0x00000800) == 0x00000800)) {
        size += com.google.protobuf.CodedOutputStream
                .computeInt32Size(76, filteredMotion_);
      }
      if (((bitField2_ & 0x00001000) == 0x00001000)) {
        size += com.google.protobuf.CodedOutputStream
                .computeInt32Size(77, fallStatus_);
      }
      if (((bitField2_ & 0x00002000) == 0x00002000)) {
        size += com.google.protobuf.CodedOutputStream
                .computeInt32Size(78, freeFall_);
      }
      if (((bitField2_ & 0x00004000) == 0x00004000)) {
        size += com.google.protobuf.CodedOutputStream
                .computeInt32Size(79, impact_);
      }
      if (((bitField2_ & 0x00008000) == 0x00008000)) {
        size += com.google.protobuf.CodedOutputStream
                .computeInt32Size(80, lying_);
      }
      if (((bitField2_ & 0x00010000) == 0x00010000)) {
        size += com.google.protobuf.CodedOutputStream
                .computeInt32Size(81, min_);
      }
      if (((bitField2_ & 0x00020000) == 0x00020000)) {
        size += com.google.protobuf.CodedOutputStream
                .computeInt32Size(82, max_);
      }
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(StnEggPkt.StnEggPacket other) {
        ...
        if (other.hasFilteredMotion()) {
          setFilteredMotion(other.getFilteredMotion());
        }
        if (other.hasFallStatus()) {
          setFallStatus(other.getFallStatus());
        }
        if (other.hasFreeFall()) {
          setFreeFall(other.getFreeFall());
        }
        if (other.hasImpact()) {
          setImpact(other.getImpact());
        }
        if (other.hasLying()) {
          setLying(other.getLying());
        }
        if (other.hasMin()) {
          setMin(other.getMin());
        }
       ...
       * <code>optional int32 filteredMotion = 76;</code>
       */
      public Builder setFilteredMotion(int value) {
        bitField2_ |= 0x00000800;
        filteredMotion_ = value;
        onChanged();
        return this;
      }
      /**
       * <code>optional int32 filteredMotion = 76;</code>
       */
      public Builder clearFilteredMotion() {
        bitField2_ = (bitField2_ & ~0x00000800);
        filteredMotion_ = 0;
        onChanged();
        return this;
       ...
       * <code>optional int32 fallStatus = 77;</code>
       */
      public Builder setFallStatus(int value) {
        bitField2_ |= 0x00001000;
        fallStatus_ = value;
        onChanged();
        return this;
       ...
       * <code>optional int32 fallStatus = 77;</code>
       */
      public Builder clearFallStatus() {
        bitField2_ = (bitField2_ & ~0x00001000);
        fallStatus_ = 0;
        onChanged();
        return this;
       ...
       * <code>optional int32 freeFall = 78;</code>
       */
      public Builder setFreeFall(int value) {
        bitField2_ |= 0x00002000;
        freeFall_ = value;
        onChanged();
        return this;
       ...
       * <code>optional int32 impact = 79;</code>
       */
      public Builder setImpact(int value) {
        bitField2_ |= 0x00004000;
        impact_ = value;
        onChanged();
        return this;
       ...
       * <code>optional int32 lying = 80;</code>
       */
      public Builder setLying(int value) {
        bitField2_ |= 0x00008000;
        lying_ = value;
        onChanged();
        return this;
  ...
  public interface PhysiqueOrBuilder extends
    ...
    /**
     * <code>required int32 heartRateHigh = 3;</code>
     */
    boolean hasHeartRateHigh();
    /**
     * <code>required int32 heartRateHigh = 3;</code>
     */
    int getHeartRateHigh();

    /**
     * <code>required int32 heartRateLow = 4;</code>
     */
    boolean hasHeartRateLow();
    /**
     * <code>required int32 heartRateLow = 4;</code>
     */
    int getHeartRateLow();
  ...
  public static final class Physique extends
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 24: {
              bitField0_ |= 0x00000004;
              heartRateHigh_ = input.readInt32();
              break;
            }
            case 32: {
              bitField0_ |= 0x00000008;
              heartRateLow_ = input.readInt32();
              break;
            }
            case 40: {
              bitField0_ |= 0x00000010;
    ...
    public static final int HEARTRATEHIGH_FIELD_NUMBER = 3;
    private int heartRateHigh_;
    /**
     * <code>required int32 heartRateHigh = 3;</code>
     */
    public boolean hasHeartRateHigh() {
      return ((bitField0_ & 0x00000004) == 0x00000004);
    }
    /**
     * <code>required int32 heartRateHigh = 3;</code>
    ...
    public int getHeartRateHigh() {
      return heartRateHigh_;
    }

    public static final int HEARTRATELOW_FIELD_NUMBER = 4;
    private int heartRateLow_;
    /**
     * <code>required int32 heartRateLow = 4;</code>
     */
    public boolean hasHeartRateLow() {
      return ((bitField0_ & 0x00000008) == 0x00000008);
    }
    /**
     * <code>required int32 heartRateLow = 4;</code>
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (((bitField0_ & 0x00000004) == 0x00000004)) {
        output.writeInt32(3, heartRateHigh_);
      }
      if (((bitField0_ & 0x00000008) == 0x00000008)) {
        output.writeInt32(4, heartRateLow_);
      }
      if (((bitField0_ & 0x00000010) == 0x00000010)) {
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000004) == 0x00000004)) {
        size += com.google.protobuf.CodedOutputStream
                .computeInt32Size(3, heartRateHigh_);
      }
      if (((bitField0_ & 0x00000008) == 0x00000008)) {
        size += com.google.protobuf.CodedOutputStream
                .computeInt32Size(4, heartRateLow_);
      }
      if (((bitField0_ & 0x00000010) == 0x00000010)) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public static final class Builder extends
      ...
      public StnEggPkt.Physique buildPartial() {
        ...
        result.heartRateHigh_ = heartRateHigh_;
        if (((from_bitField0_ & 0x00000008) == 0x00000008)) {
          to_bitField0_ |= 0x00000008;
        }
        result.heartRateLow_ = heartRateLow_;
        if (((from_bitField0_ & 0x00000010) == 0x00000010)) {
          to_bitField0_ |= 0x00000010;
        }
      ...
      public Builder mergeFrom(StnEggPkt.Physique other) {
        ...
        if (other.hasHeartRateHigh()) {
          setHeartRateHigh(other.getHeartRateHigh());
        }
        if (other.hasHeartRateLow()) {
          setHeartRateLow(other.getHeartRateLow());
        }
        if (other.hasGender()) {
       ...
       * <code>required int32 heartRateHigh = 3;</code>
       */
      public Builder setHeartRateHigh(int value) {
        bitField0_ |= 0x00000004;
        heartRateHigh_ = value;
        onChanged();
        return this;
      }
      /**
       * <code>required int32 heartRateHigh = 3;</code>
       */
      public Builder clearHeartRateHigh() {
        bitField0_ = (bitField0_ & ~0x00000004);
        heartRateHigh_ = 0;
        onChanged();
        return this;
       ...
       * <code>required int32 heartRateLow = 4;</code>
       */
      public Builder setHeartRateLow(int value) {
        bitField0_ |= 0x00000008;
        heartRateLow_ = value;
        onChanged();
        return this;
       ...
       * <code>required int32 heartRateLow = 4;</code>
       */
      public Builder clearHeartRateLow() {
        bitField0_ = (bitField0_ & ~0x00000008);
        heartRateLow_ = 0;
        onChanged();
        return this;
  ...
  static {
    java.lang.String[] descriptorData = {
            ...
            "\002(\005\022\020\n\010adr_0x2C\030\031 \002(\005\022\020\n\010adr_0x2D\030\032 \002(\005\022" +
                    ...
                    "_0x55\030( \002(\005\"\362\001\n\004Gait\022\021\n\tpositionX\030\001 \001(\002\022" +
    ...
    internal_static_Physique_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_Physique_descriptor,
            new java.lang.String[] { "Height", "Weight", "HeartRateHigh", "HeartRateLow", "Gender", });
  }
