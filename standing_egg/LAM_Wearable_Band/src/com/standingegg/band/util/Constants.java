...
public class Constants {
	...
	public static final String USER_DEVICEADDRESS = "user_deviceaddress";
	...
	public static final String TODAY_ACT_GOAL_OK = "today_act_goal_ok";

	public static final String TODAY_SAVE_DATA_DATE = "today_save_data_date";
	public static final String TODAY_SAVE_DATA_YEAR = "today_save_data_year";
	public static final String TODAY_SAVE_DATA_MONTH = "today_save_data_month";
	public static final String TODAY_SAVE_DATA_DAY = "today_save_data_day";
	public static final String TODAY_ACTIVITY_CNT = "today_activity_cnt";
	public static final String TODAY_ACT_GRAPH_CNT = "today_act_graph_cnt";
	public static final String TODAY_ACT_GRAPH_TIME = "today_act_graph_time"; // .... 시간대별 구분자..?
	public static final String TODAY_ACT_GRAPH_TIME_HOUR = "today_act_graph_time_hour"; // .... 시간대별 구분자..?
	public static final String TODAY_ACT_GRAPH_TIME_MIN = "today_act_graph_time_min"; // .... 시간대별 구분자..?
	
	public static final String TODAY_ACT_WALK_DIS = "today_act_walk_dis";
//	public static final String TODAY_ACT_WALK_H = "today_act_walk_h";
	public static final String TODAY_ACT_WALK_M = "today_act_walk_m";
	public static final String TODAY_ACT_WALK_CAL = "today_act_walk_cal";
	public static final String TODAY_ACT_RUN_DIS = "today_act_run_dis";
//	public static final String TODAY_ACT_RUN_H = "today_act_run_h";
	public static final String TODAY_ACT_RUN_M = "today_act_run_m";
	public static final String TODAY_ACT_RUN_CAL = "today_act_run_cal";
	
	public static final String TODAY_TIME_LINE_1 = "today_time_line_1";
	public static final String TODAY_TIME_LINE_2 = "today_time_line_2";

//	public static final String TODAY_DEEP_SLEEP_H = "today_deep_sleep_h";
	public static final String TODAY_DEEP_SLEEP_M = "today_deep_sleep_m";
	public static final String TODAY_LOW_SLEEP_M = "today_low_sleep_m";
	public static final String TODAY_AWAKE_SLEEP_M = "today_awake_sleep_m";
	public static final String TODAY_SLEEP_START = "today_sleep_start";
	public static final String TODAY_SLEEP_WAKEUP = "today_sleep_wakeup";
	public static final String TODAY_SLEEP_GRAPH_HEIGHT = "today_sleep_graph_height";
	public static final String TODAY_SLEEP_GRAPH_CNT = "today_sleep_graph_cnt";
	...
	public static final String PREFERENCE_ALL_DIS = "preference_all_dis";
	...
	public static final String PREFERENCE_KAKAO_NOTI = "setting_kakao_noti";
	...
	public static final String PREFERENCE_ALARM_DAY_TEXT = "alarm_day_text";
	public static final String PREFERENCE_ALARM_ONOFF= "alarm_onoff";
	public static final String PREFERENCE_ALARM_DAYS_TEXT = "alarm_days_text";
